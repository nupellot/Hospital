select distinct * from (
    SELECT story.*, doctor.*, patient.image AS "patient_image", patient.name AS "patient_name", patient.surname AS "patient_surname", patient.patronymic AS "patient_patronymic", patient.login AS "patient_login", ward.*, department.*
